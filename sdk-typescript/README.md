...
For more information about the API: [Find out more about Users API](https://www.example.com)
<!-- End Summary [summary] -->
...
* [createUser](docs/sdks/sdk/README.md#createuser)
* [getUser](docs/sdks/sdk/README.md#getuser)
...
| ----------------------------- | ----------------------------- | ----------------------------- |
| errors.CreateMessageObject    | 404                           | application/json              |
| errors.CreateUserResponseBody | 422                           | application/json              |
...
async function run() {
  ...
  try {
    ...
    switch (true) {
      ...
      case (err instanceof CreateMessageObject): {
        // Handle err.data$: CreateMessageObjectData
        console.error(err);
        return;
      }
      case (err instanceof CreateUserResponseBody): {
        // Handle err.data$: CreateUserResponseBodyData
        console.error(err);
        return;
      }
      default: {
